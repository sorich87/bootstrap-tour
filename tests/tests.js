...
(function() {
  ...
  test("Tour.getState should get state cookie", function() {
    ...
    strictEqual(this.tour.getState("get"), "yes", "tour gets state cookie");
  ...
  test("Tour.getState should get state localStorage items", function() {
    ...
    this.tour.setState("test", "yes");
    strictEqual(this.tour.getState("test"), "yes", "tour saves state localStorage items");
  ...
  test("Tour.addStep should add a step", function() {
    ...
    return deepEqual(this.tour._steps, [step], "tour adds the step");
  });

  test("Tour.addSteps should add multiple step", function() {
    ...
    return deepEqual(this.tour._steps, [firstStep, secondStep], "tour adds multiple steps");
  });
  ...
  test("basePath should prepend the path to the steps", function() {
    this.tour = new Tour({
      basePath: 'test/'
    });
    this.tour.addStep({
    ...
    return strictEqual(this.tour._isRedirect(this.tour._options.basePath + this.tour.getStep(0).path, 'test/test.html'), false, "Tour adds basePath to step path");
  });

  test("Tour with onNext option should run the callback before showing the next step", function() {
    var tour_test;
    tour_test = 0;
    this.tour = new Tour({
      onNext: function() {
    ...
    this.tour.start();
    this.tour.next();
    return strictEqual(tour_test, 2, "tour runs onNext when next step is called");
  });

  test("Tour.addStep with onNext option should run the callback before showing the next step", function() {
    var tour_test;
    tour_test = 0;
    this.tour = new Tour();
    this.tour.addStep({
  ...
  test("Tour with onPrev option should run the callback before showing the prev step", function() {
    var tour_test;
    tour_test = 0;
    this.tour = new Tour({
      onPrev: function() {
    ...
    this.tour.next();
    this.tour.prev();
    return strictEqual(tour_test, 2, "tour runs onPrev when prev step is called");
  });

  test("Tour.addStep with onPrev option should run the callback before showing the prev step", function() {
    var tour_test;
    tour_test = 0;
    this.tour = new Tour();
    this.tour.addStep({
